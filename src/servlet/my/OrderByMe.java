 ...
 */
public class OrderByMe extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		List<Productorder> list=dao.findAll("order_by", (String) request.getSession().getAttribute(config.Config.USER_ID),key,r);
		...
		request.getRequestDispatcher("/my/orderByMe.jsp").forward(request, response);return;
	}
