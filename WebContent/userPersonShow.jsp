		...
		<div id="pad-wrapper" class="user-profile">
			...
			<div class="row header">
				<div class="col-md-8">
					...
					<h3 class="name"><%=user.getNickname()%></h3>
				...
				<div class="col-md-9 bio">
					...
					Map list1 = (Map) request.getAttribute("productordermap1");
						...
						while (iter.hasNext()) {
							...
							out.println("<td class=\"col-md-1 sortable\">赠送人&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td><td colspan=\"3\" class=\"col-md-1 sortable\">");
							out.println(p.getToNickname());
							out.println("</td></tr>");
							out.println("<tr><td class=\"col-md-1 sortable\">总价值&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td><td class=\"col-md-1 sortable\">"
					...
					<!-- new comment form -->
					<div class="col-md-12 section comment"  <%if(user.getUserId().equals((String)request.getSession().getAttribute(Config.USER_ID))){out.print("style=\"display:none;\"");} %>>
						<h4>给TA送礼</h4>
						<p>为你们的互动留下你的足迹</p>
