	...
	<div class="content">
		...
		<div id="pad-wrapper" class="user-profile">
			...
			<div class="col-md-9 bio">
				...
				<div class="row">
					<div class="col-md-12">
						<form method="post" action="<%=basePath%>admin/userInfoUpdate">
								...
								<tbody>
									...
									<tr class="first">
										...
										<td><a class="btn-flat small"
											href="<%=basePath%>admin/userPasswdUpdate.jsp?uid=<%=user.getUserId()%>">修改密码</a>
										</td>
									</tr>
									<tr class="first">
										<td>头像</td>
										<td><a
											href="<%=basePath%>admin/userAvatarUpdate?uid=<%=user.getUserId()%>"
											class="name"> <img src="<%=(basePath + user.getAvatar())%>"
									...
									<tr class="first">
										...
										<td><input type="text" class="col-md-9 form-control"
											id="nickname" name="nickname" value="<%=user.getNickname()%>" />
									...
									<tr class="first">
										<td>姓名</td>
										<td><input type="text" class="col-md-9 form-control"
											id="truename" name="truename" value="<%=user.getTruename()%>"></td>
									</tr>
									<tr class="first">
										<td>性别</td>
