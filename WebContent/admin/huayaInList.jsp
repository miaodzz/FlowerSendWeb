		...
		<div class="row">
			...
			<div class="col-md-12">
				<table class="table table-hover">
					<thead>
						<tr>
							<th class="col-md-2 sortable">提现处理号</th>
					...
					<tbody>
						<%
							...
							for (HuayaPurchase hp : list) {
								...
								out.print("<td> <a class=\"btn-flat small\" href=\""+basePath+"admin/huayaInUpdate?sid="+hp.getSerialnumber()+"\">修改</a>");
								out.print(" <a class=\"btn-flat small\" href=\""+basePath+"admin/huayaInDelete?sid="+hp.getSerialnumber()+"\">删除</a></td>");
								out.print("</tr>");
