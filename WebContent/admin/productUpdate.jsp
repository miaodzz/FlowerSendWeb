	...
	<div class="content">
		...
		<div id="pad-wrapper" class="user-profile">
			...
			<div class="col-md-9 bio">
				...
				<div class="row">
					<div class="col-md-12">
						<form method="post" action="<%=basePath%>admin/productUpdate">
						<input type="hidden" name="pid" value="<%=p.getProductId() %>">
							<table class="table table-hover">
								<tbody>
									<tr class="first">
										<td>商品图片</td>
										<td><a href="<%=basePath%>admin/productPictureUpdate?pid=<%=p.getProductId()%>" class="name"><img src="<%=basePath+p.getProductPicture()%>"/>
										</a></td>
									</tr>
									<tr class="first">
										<td>商品名称</td>
